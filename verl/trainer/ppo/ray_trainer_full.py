...
class RayPPOTrainer:
    ...
    def _compute_keypoint_reward_scores(self, batch: DataProto):
        ...
        # (debug print of full decoded answers removed)
        ...
        # (debug print of variants_dp removed)
        ...
        for idx, (s, k_idx, start_pos, k_len) in enumerate(variant_meta):
            ...
            # (debug print of per-variant probabilities removed)
        ...
        # (debug print of final reward removed)
